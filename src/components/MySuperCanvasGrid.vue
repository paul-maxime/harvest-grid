...
<template>
  <canvas @wheel="onWheel" @mousedown="onMouseDown" @mousemove="onMouseMove" @mouseup="onMouseUp" @mouseleave="onMouseLeave" ref="garden" width="512" height="512">Garden</canvas>
</template>
